...
import cn.xmall.common.utils.FastDFSClient;
...
public class FastDfsTest {
	...
	public void testFastDfsClient() throws Exception {
		FastDFSClient fastDFSClient = new FastDFSClient("C:/EclipseWorkspace/XMALL/xmall-manager-web/src/main/resources/conf/client.conf");
		String string = fastDFSClient.uploadFile("C:/Users/jiangliang/Pictures/ico/cicle.png");
		System.out.println(string);
	}
}
