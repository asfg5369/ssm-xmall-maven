...
public class XmallResult implements Serializable{
...
//    }
     ...
     * @return
     */
    public static XmallResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, XmallResult.class);
            }
     ...
     * @return
     */
    public static XmallResult format(String json) {
        try {
            return MAPPER.readValue(json, XmallResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static XmallResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
