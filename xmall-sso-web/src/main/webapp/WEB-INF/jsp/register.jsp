	...
	<div class="reg_main reg_border regTab" id="perDiv">
		<ul class="individualUserBg">
			<form id="regForm_mod" name="regForm_mod" method="post">
				...
				<li class="regMb30"><label><font>*</font> 账户名：</label> <span
				...
				<li><label><font>*</font> 登录密码：</label> <span
					class="regM defaultBorder"> <input id="pwd" name="password"
						...
						onfocus="showPwdtip('password','passwordErr',2);"
				...
				<li class="safetyLayer regPl191" id="pwdStrong"><font
					style="font-size: 12px;">安全程度：</font><em class="default">弱</em><em
					class="default">中</em><em class="default">强</em></li>

				<li class="regMb30"><label><font>*</font> 确认密码：</label> <span
					class="regM defaultBorder"> <input id="pwdRepeat"
				...
				<li class="regMb30"><label><font>*</font> 验证手机：</label> <span
					class="regM defaultBorder"> <input id="phone" name="phone"
						autocomplete="off" class="regInput" type="text" maxlength="11"
						onfocus="showtip('phone','phoneErr',1);"
						onblur="$('#phoneErr').html('')" /> <em></em>
				...
				<li class="regPl88"><span class="regM"
					style="margin-left: 29px"> <input id="AgreeId"
						name="AgreeId" type="checkbox" checked="" onclick="ckAgree();">
							<a href="https://passport.xmall.cn/xy.html" target="_blank"
		...
		<div class="ui-reg-tip">
			<a href="http://help.xmall.cn/140/6788.html" target="_blank">了解更多>></a>
		</div>
	</div>
