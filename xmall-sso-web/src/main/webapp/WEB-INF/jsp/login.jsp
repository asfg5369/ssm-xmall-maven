...
<body>
	...
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.xmall.cn/html/activity/1472720729.html"
				target="_blank"><img
			...
			<div class="login_box clear">
						...
						<form id="formlogin" method="post">
							...
							<li>
								<div style="width: 65px; margin-left: 260px;">
									<a
										href="https://passport.xmall.cn/reg/findpass/?returnUrl=http://www.xmall.cn"
				...
				<ul class="blink">
					<li class="p-f10">
						...
						<div>
							<a
								href="http://api2.xmall.cn/unionlogin/qq/oauth/qq_login.php?returnUrl=http://www.xmall.cn/"
								class="link">QQ</a>&nbsp;|&nbsp; <a
								href="https://api.weibo.com/oauth2/authorize?client_id=1800908332&amp;redirect_uri=https%3A%2F%2Fpassport.xmall.cn%2Fcallback%2Fsina&amp;response_type=code&amp;state=&amp;display=?returnUrl=http://www.xmall.cn/"
								class="link">新浪微博</a> &nbsp;|&nbsp; <a
								href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801198099&amp;redirect_uri=https%3A%2F%2Fpassport.xmall.cn%2Fcallback%2Fqq&amp;response_type=code&amp;type=?returnUrl=http://www.xmall.cn/"
								class="link">腾讯微博</a> &nbsp;|&nbsp; <a
								href="http://api2.xmall.cn/unionlogin/alipay.php?returnUrl=http://www.xmall.cn/"
								class="link">支付宝</a>
						</div>
					</li>
				</ul>
	...
	<div class="footer">
		<span> <a href="http://www.xmall.cn/www/379/5109.html"
			...
			href="http://supplier.xmall.cn/supplierApply" rel="nofollow"
			class="footerlink1">供应商申请</a>
		</span>
		<p>
			北京XMALL电子商务有限公司<br> 北京市公安局顺义分局备案11011302000890号|<a
				href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow"
				class="footerlink1">京ICP备12011349号</a>|<a
				href="http://www.xmall.cn/www/174/461.html" target="_blank"
				rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright©
					XMALL商城 xmall.cn 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
	<script type="text/javascript">
		...
		var LOGIN = {
			checkInput : function() {
				$("#sfbestNameErr").attr("class", "").html("").prev().attr(
						"class", "border");
				$("#sfbestPwdErr").attr("class", "").html("").prev().attr(
						"class", "border");

				if (!$("#formlogin #loginname").val()) {
					$("#sfbestNameErr").attr("class", "error").show().html(
							"请输入用户名").prev().attr("class", "border-error");
					return false;
				}
				if (!$("#formlogin input[name='password']").val()) {
					$("#sfbestPwdErr").attr("class", "error").show().html(
							"请输入密码").prev().attr("class", "border-error");
					return false;
				}
